        ...
        <CenteredCard>
          <div className="space-y-6 w-full h-full">
            <div className="flex flex-col h-full w-full">
              ...
              <div className="font-bold text-2xl text-black flex-1 flex flex-col md:flex-row gap-3 justify-between mt-4">
                <button className="flex-1 bg-gray-200 text-black py-3 px-4 rounded-full md:rounded-l-full md:rounded-r-none text-center md:text-left">
                  <p className="text-sm font-medium">Get Invitation Code</p>
                </button>
                <button className="flex-1 bg-gray-200 text-black py-3 px-4 rounded-full md:rounded-l-none md:rounded-r-full text-center md:text-right">
